package items
{
	...
	public class ItemManager {
		...
		private static var switchSpikeDoorsUpBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeDoorsDownBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeGatesUpBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeGatesDownBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		...
		private static var switchSpikeOrangeDoorsUpBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeOrangeDoorsDownBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeOrangeGatesUpBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		private static var switchSpikeOrangeGatesDownBMD:BitmapData = new BitmapData(16*1000, 16, true, 0x0);
		...
		public static var sprSpikePurpleDoorUP:BlockSprite;
		public static var sprSpikePurpleDoorDOWN:BlockSprite;
		public static var sprSpikePurpleGateUP:BlockSprite;
		public static var sprSpikePurpleGateDOWN:BlockSprite;
		public static var sprSpikeOrangeDoorUP:BlockSprite;
		public static var sprSpikeOrangeDoorDOWN:BlockSprite;
		public static var sprSpikeOrangeGateUP:BlockSprite;
		public static var sprSpikeOrangeGateDOWN:BlockSprite;
		...
		public static function init():void
		{
			...
			var spikeswitches:ItemBrickPackage = new ItemBrickPackage("switch spikes", "Switch Spikes", ["Kill", "Die", "Respawn", "Death", "Trap", "Fatal", "Deadly", "Spikes"]);
			spikeswitches.addBrick(createBrick(ItemId.SPIKE_GATE_PURPLE, ItemLayer.DECORATION, specialBlocksBMD, "", "", ItemTab.ACTION, false, false, 898, -1, ["Gate", "Purple", "Violet"]));
			spikeswitches.addBrick(createBrick(ItemId.SPIKE_DOOR_PURPLE , ItemLayer.DECORATION, specialBlocksBMD, "", "", ItemTab.ACTION, false, false, 900, -1, ["Door", "Purple", "Violet"]));
			spikeswitches.addBrick(createBrick(ItemId.SPIKE_GATE_ORANGE, ItemLayer.DECORATION, specialBlocksBMD, "", "", ItemTab.ACTION, false, false, 902, -1, ["Gate", "Orange"]));
			spikeswitches.addBrick(createBrick(ItemId.SPIKE_DOOR_ORANGE , ItemLayer.DECORATION, specialBlocksBMD, "", "", ItemTab.ACTION, false, false, 904, -1, ["Door","Orange"]));
			brickPackages.push(spikeswitches);
...
//			water.addBrick(createBrick(ItemId.WATER, ItemLayer.ABOVE, waterBMD, "", ItemTab.ACTION,false,false,0,0x0));
			...
			var advfakeplay:ItemBrickPackage = new ItemBrickPackage("Fake Player", "Fake Player", ["fake", "advanced","player"]);
			advfakeplay.addBrick(createBrick(ItemId.FAKEPLAYER_ADD, ItemLayer.DECORATION, decoBlocksBMD, "", "", ItemTab.ACTION, false, false, 368, 0x0, ["Add"]));
			
			//add npcs brick package declared earlier so they will end up in the end of Action tab. Ha no, advanced is now last since it's advanced
			brickPackages.push(npc);
			brickPackages.push(advfakeplay);
			...
			for (var a:int = 0; a <= 1000; a++)
			{
				...
				if (a < 1000) {
					...
					switchSpikeDoorsUpBMD.copyPixels(bmdBricks[ItemId.SPIKE_DOOR_PURPLE],bmdBricks[ItemId.SPIKE_DOOR_PURPLE].rect, new Point(16*a,0));
					switchSpikeDoorsDownBMD.copyPixels(specialBlocksBMD, new Rectangle(901*16,0,16,16), new Point(16*a,0));
					switchSpikeGatesUpBMD.copyPixels(bmdBricks[ItemId.SPIKE_GATE_PURPLE],bmdBricks[ItemId.SPIKE_GATE_PURPLE].rect, new Point(16*a,0));
					switchSpikeGatesDownBMD.copyPixels(specialBlocksBMD, new Rectangle(899 * 16, 0, 16, 16), new Point(16 * a, 0));
					switchSpikeOrangeDoorsUpBMD.copyPixels(bmdBricks[ItemId.SPIKE_DOOR_ORANGE],bmdBricks[ItemId.SPIKE_DOOR_ORANGE].rect, new Point(16*a,0));
					switchSpikeOrangeDoorsDownBMD.copyPixels(specialBlocksBMD, new Rectangle(905*16,0,16,16), new Point(16*a,0));
					switchSpikeOrangeGatesUpBMD.copyPixels(bmdBricks[ItemId.SPIKE_GATE_ORANGE],bmdBricks[ItemId.SPIKE_GATE_ORANGE].rect, new Point(16*a,0));
					switchSpikeOrangeGatesDownBMD.copyPixels(specialBlocksBMD, new Rectangle(903*16,0,16,16), new Point(16*a,0));
				...
				if (a < 1000) {
					...
					switchOrangeSwitchResetBMD.draw(blockText, m);
					switchSpikeDoorsUpBMD.draw(blockText, m);
					switchSpikeDoorsDownBMD.draw(blockText, m);
					switchSpikeGatesUpBMD.draw(blockText, m);
					switchSpikeGatesDownBMD.draw(blockText, m);
					switchSpikeOrangeDoorsUpBMD.draw(blockText, m);
					switchSpikeOrangeDoorsDownBMD.draw(blockText, m);
					switchSpikeOrangeGatesUpBMD.draw(blockText, m);
					switchSpikeOrangeGatesDownBMD.draw(blockText, m);
			...
			sprSpikePurpleDoorUP = new BlockSprite(switchSpikeDoorsUpBMD , 0, 0, 16, 16, switchSpikeDoorsUpBMD.width / 16, true)
			sprSpikePurpleDoorDOWN = new BlockSprite(switchSpikeDoorsDownBMD , 0, 0, 16, 16, switchSpikeDoorsDownBMD.width / 16, true)
			sprSpikePurpleGateUP = new BlockSprite(switchSpikeGatesUpBMD , 0, 0, 16, 16, switchSpikeGatesUpBMD.width / 16, true)
			sprSpikePurpleGateDOWN = new BlockSprite(switchSpikeGatesDownBMD , 0, 0, 16, 16, switchSpikeGatesDownBMD.width / 16, true)
			sprSpikeOrangeDoorUP = new BlockSprite(switchSpikeOrangeDoorsUpBMD , 0, 0, 16, 16, switchSpikeOrangeDoorsUpBMD.width / 16, true)
			sprSpikeOrangeDoorDOWN = new BlockSprite(switchSpikeOrangeDoorsDownBMD , 0, 0, 16, 16, switchSpikeOrangeDoorsDownBMD.width / 16, true)
			sprSpikeOrangeGateUP = new BlockSprite(switchSpikeOrangeGatesUpBMD , 0, 0, 16, 16, switchSpikeOrangeGatesUpBMD.width / 16, true)
			sprSpikeOrangeGateDOWN = new BlockSprite(switchSpikeOrangeGatesDownBMD , 0,0,16,16,switchSpikeOrangeGatesDownBMD.width/16, true)
